...
devs <- read.csv("Data/devices.csv", header=TRUE)
devs
devs$devper <- round(devs$Views/sum(devs$Views)*100, 2)


library(xlsx)
survey <- read.xlsx("Data/PH750-2 online tech 07-09.xlsx", sheetIndex=1, header=TRUE)
head(survey,10)
survey$What.was.your.preferred.way.to.attend.lectures.for.this.course.
